...
const Process = () => {
    return ( 
        <div className="w-full min-h-[70vh] mt-[20px] bg-[#05192D] pt-[35px]">
            <h1 className="gochi uppercase text-[white] font-normal text-[50px] text-center">our process</h1>
            <div className="max-w-[70%] h-[50vh] mx-auto grid grid-cols-2 gap-2.5">
                <div className="flex fle-row items-center pr-[10px]">
                    <img src={Frame} alt="" className="w-[25px] h-[25px]" />
                    <span className="ml-[22px]">
                        <h4 className="text-[white] texting font-bold text-[20px]">Learn anywhere</h4>
                ...
                <div className="flex fle-row items-center pr-[10px]">
                    <img src={Frame} alt="" className="w-[25px] h-[25px]" />
                    <span className="ml-[22px]">
                        <h4 className="text-[white] texting font-bold text-[20px]">Learn the financially responsible way</h4>
                ...
                <div className="flex fle-row items-center pr-[10px]">
                    <img src={Frame} alt="" className="w-[25px] h-[25px]" />
                    <span className="ml-[22px]">
                        <h4 className="text-[white] texting font-bold text-[20px]">Learn from the Best</h4>
                ...
                <div className="flex fle-row items-center pr-[10px]">
                    <img src={Frame} alt="" className="w-[25px] h-[25px]" />
                    <span className="ml-[22px]">
                        <h4 className="text-[white] texting font-bold text-[20px]">Learn in comfort</h4>

    ...
    return ( 
        <div className="w-full min-h-[100vh] py-[50px]">
            ...
            <div className="w-[70%] h-[80vh] grid grid-cols-3 mx-auto gap-x-2.5 mt-[30px]">
                ...
                <div className="flex flex-col justify-between py-[50px] px-[24px] text-[black] hover:text-[white] hover:bg-[black] hover:rounded-xl">
                ...
                <div className="flex flex-col justify-between py-[50px] px-[25px] text-[black] hover:text-[white] hover:bg-[black] hover:rounded-xl">

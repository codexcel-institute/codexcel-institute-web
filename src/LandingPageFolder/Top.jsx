...
function Top() {
  ...
  return (
    <section className="flex bg-[rgba(5,25,45,1)] text-white items-center flex-col gap-4 h-[420px] md:min-h-[430px] lg:min-h-[calc(100svh-80px)] py-6 px-5 text-center">

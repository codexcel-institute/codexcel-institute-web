...
function Top() {
  ...
  return (
    <section className="flex bg-[rgba(5,25,45,1)] text-white items-center flex-col gap-4 min-h-[calc(100svh-80px)] h-fit py-6 px-5 text-center">
        <p className='text-lg mb-6'>START YOUR CAREER IN TECH</p>
        <h1 className='text-6xl gochi leading-[70px]'>
            <span>BECOME A </span>
            <span className='bg-[rgba(52,168,83,0.1)] text-[rgba(0,255,68,1)] px-3'>{text}<Cursor /></span>
            
        </h1>
        <h1 className='text-6xl gochi'>IN 6 MONTHS</h1>
